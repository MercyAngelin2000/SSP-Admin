    ...
    <>
        ...
        <div className='container-fluid card mb-5 container-card '>
          ...
          <section id='regiontbl'>
            <div className='d-flex justify-content-between align-items-end mt-1 p-0'>
              ...
              <div>
                {/* onClick={() => handleAdd()}  */}
                <button className='btn btn-sm add px-2' onClick={closeSidebar} data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
      ...
      <div ref={offcanvasRef} class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
          <h5 id="offcanvasRightLabel">Add User Role</h5>
          ...
          <form autoComplete='off' style={{ fontSize: '12px' }}>
            ...
            <div className='mt-4'>
              ...
              <div className='d-flex justify-content-end mt-3'>
                <div className='mr-2'>
                  <button type="button" data-bs-dismiss="offcanvas" aria-label="Close" style={{ marginRight: "10px", backgroundColor: "#e54e60" }} className="btn btn-sm text-white" >Cancel</button>
                </div>
                <div className='ml-2'>
