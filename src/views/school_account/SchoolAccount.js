                    ...
                    <>
                        <div className='card p-2 container-card'>
                            <div className='d-flex justify-content-between align-items-end mb-3'>
                                ...
                                <div>
                                    <button className='btn btn-sm add px-2' title='Add' onClick={() => handleAdd()}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
