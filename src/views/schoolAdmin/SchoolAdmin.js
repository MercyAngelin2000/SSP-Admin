                ...
                {selectedTab === 'schooladmin' &&
                    <section id='regiontbl'>
                        <div className='d-flex justify-content-between align-items-end mt-1 p-0'>
                            ...
                            <div>
                                <button className='btn  btn-sm add px-2' onClick={() => navigate('/addSchoolAdmin', { state: { mode: 'add' } })}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
