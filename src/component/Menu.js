  ...
  return (
    <div className={"sidebar " + (barStatus ? "open" : "")}>
      ...
      <ul className="nav-list px-3">
        ...
        <li id="region" className={activeTab === "region" ? "active" : ""} onClick={() => handleTabChange('region')}>
          <p>
            <i>
        ...
        <li id="corporate" className={activeTab === "corporate" ? "active" : ""} onClick={() => handleTabChange('corporate')}>
          ...
          <span className="tooltip">Corporate</span>
        </li>
        <li id="corporate" className={activeTab === "campus" ? "active" : ""} onClick={() => handleTabChange('campus')}>
          <p>
            <i>
